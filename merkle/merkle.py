...
class MerkleSftp():
    ...
    def __init__(self, logger, stage, data):
        ...
        self.stage = stage
        self.logger = logger
        self.meta = json.loads(os.environ["mrkle_meta"])  # get the meta data needed for the payload
        self.data = data
    ...
    def set_credentials(self):
        ...
        self.logger.info("MerkleSftp.set_credentials: start")
        self.logger.info(f"MerkleSftp.set_credentials: useing {self.stage}")
    ...
    def build_payload(self):
        ...
        self.logger.info("MerkleSftp.build_payload: building...")
...
"""
        self.logger.info(f"MerkleSftp.build_payload: end:\n{payload}")
    ...
    def convert_to_xml(self):
        ...
        self.logger.info("MerkleSftp.convert_to_xml: converting...")
    ...
    def set_filename(self):
        ...
        self.logger.info("MerkleSftp.set_filename: start")

        filename = f"_{self.meta['ProductCode']}_CNSMR_W_{date_time_str}_4.xml"

        self.logger.info(f"MerkleSftp.set_filename: end - filename {filename}")
    ...
    def save_temp_payload_file(self):
        ...
        self.logger.info("MerkleSftp.save_temp_payload_file: start")
        ...
        self.logger.info("MerkleSftp.save_temp_payload_file: end")
    ...
    def transfer_data(self):
        ...
        self.logger.info("MerkleSftp.transfer_data: start")
        ...
        self.logger.info("MerkleSftp.transfer_data: Create a transport")
        transport = paramiko.Transport((os.environ["ftp_host"], 22))

        # connect to server
        self.logger.info("MerkleSftp.transfer_data: connect to server")
        transport.connect(None, self.ftp_username, self.ftp_password)

        self.logger.info("MerkleSftp.transfer_data: Try creating an sftp client")
        try:
            sftp = paramiko.SFTPClient.from_transport(transport)
            self.logger.info(sftp)
            ...
            self.logger.error("MerkleSftp.transfer_data: Failed")
            self.logger.error(f"MerkleSftp.transfer_data: {e}")

        self.logger.info("MerkleSftp.transfer_data: end")
